  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold text-foreground">{dict.notFound.title}</h1>
        <h2 className="mt-4 text-xl font-semibold text-foreground">{dict.notFound.heading}</h2>
